        ...
        <div className='w-full bg-black py-[50px]' id='footer'>
            ...
            <div className='max-w-[1200px] p-3 md:p-4 rounded mx-auto flex flex-col gap-9 md:gap-[50px] shadow-sm shadow-black'>
                <div className='flex flex-row justify-around md:gap-3'>
                    <ul className='flex flex-row md:flex-col md:gap-2 md:w-[20px]'>
                        <ul>
                            <li className='corsor-pointer text-white hover:text-green-500 text-[13px] md:text-[18px]'> <span className='text-green-400'>✔ </span>ECM Repair</li>
                            <li className='corsor-pointer text-white hover:text-green-500 text-[13px] md:text-[18px]'> <span className='text-green-400'>✔ </span>Diagnostics</li>
                            <li className='corsor-pointer text-white hover:text-green-500 text-[13px] md:text-[18px]'> <span className='text-green-400'>✔ </span>Car Wiring</li>
                            <li className='corsor-pointer text-white hover:text-green-500 text-[13px] md:text-[18px]'> <span className='text-green-400'>✔ </span>Electrical Solutions</li>
                        </ul>
                        <ul>
                            <li className='corsor-pointer text-white hover:text-green-500 text-[13px] md:text-[18px]'> <span className='text-green-400'>✔ </span>Alternator Repair</li>
                            <li className='corsor-pointer text-white hover:text-green-500 text-[13px] md:text-[18px]'> <span className='text-green-400'>✔ </span>Self Motor Repair</li>
                            <li className='corsor-pointer text-white hover:text-green-500 text-[13px] md:text-[18px]'> <span className='text-green-400'>✔ </span>Key Programming</li>
                            <li className='corsor-pointer text-white hover:text-green-500 text-[13px] md:text-[18px]'> <span className='text-green-400'>✔ </span>Remote Configuration</li>
                        </ul>
                        <ul>
                            ...
                            <li className='corsor-pointer text-white hover:text-green-500 text-[13px] md:text-[18px]'> <span className='text-green-400'>✔ </span>Meter</li>
                            <li className='corsor-pointer text-white hover:text-green-500 text-[13px] md:text-[18px]'> <span className='text-green-400'>✔ </span>Dashboard Diagnostics</li>
                        </ul>
                    </ul>
