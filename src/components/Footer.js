                ...
                <div className='flex flex-row justify-around md:gap-3'>
                    <ul className='flex flex-row justify-between gap-5 md:flex-col md:gap-2 md:w-[20px]'>
                        <ul className='flex flex-col gap-2'>
                            <li className='corsor-pointer text-white hover:text-green-500 text-[12.5px] md:text-[18px]'> <span className='text-green-400'>✔ </span>JSC CAN Box</li>
                            ...
                            <li className='corsor-pointer text-white hover:text-green-500 text-[12.5px] md:text-[18px]'> <span className='text-green-400'>✔ </span>Cluster Meter Repair</li>
                            <li className='corsor-pointer text-white hover:text-green-500 text-[12.5px] md:text-[18px]'> <span className='text-green-400'>✔ </span>EPS Repair</li>
                        </ul>
                        <ul className='flex flex-col gap-2'>
                            ...
                            <li className='corsor-pointer text-white hover:text-green-500 text-[12.5px] md:text-[18px]'> <span className='text-green-400'>✔ </span>BCM Repair</li>
                            <li className='corsor-pointer text-white hover:text-green-500 text-[12.5px] md:text-[18px]'> <span className='text-green-400'>✔ </span>Key Programming</li>
                            <li className='corsor-pointer text-white hover:text-green-500 text-[12.5px] md:text-[18px]'> <span className='text-green-400'>✔ </span>ECM (Engine Control Module)</li>
                        </ul>
                    </ul>
