...
const HeroSection = () => {
    ...
    return (
        <>
            ...
            <div className='w-full h-[600px] md:h-[670px] bg-gradient-to-r from-blue-900 to-white p-5' id='home'>
                <div className='max-w-[1240px] mx-auto flex flex-col md:flex-row justify-center md:justify-between md:gap-6
                 items-center mt-[160px] md:mt-[230px]'>
                    <div className='flex flex-col text-center md:text-start gap-2 md:gap-4 mb-[100px] md:w-[845px]'>
                        ...
                        <p className='text-[10px] md:text-3xl text-white font-semibold'>Your Trusted Garage Solution! <span className='text-white' ref={typedElement}></span></p>
                    </div>
