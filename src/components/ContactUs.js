...
export default function ContactUs() {
    return (
        <div className='md:w-full pt-[50px] pb-[53px] md:pt-[130px] md:pb-[120px] bg-[#181818]' id='contact'>
            <h1 className='text-2xl md:text-4xl font-semibold text-center text-white'>Contact Us</h1>
            <div className='flex flex-col md:flex-row md:my-[70px] md:gap-5 p-3'>
                ...
                <div className='md:w-[2000px] text-semibold bg-[#181818] p-4 h-[250px] md:h-[270px] shadow-md shadow-black overflow-y-scroll md:overflow-auto
